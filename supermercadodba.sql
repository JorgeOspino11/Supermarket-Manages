...
-- Tiempo de generación: 09-05-2025 a las 16:44:46
...
--
-- Estructura de tabla para la tabla `inventarios_sucursales`
--
...
--
-- Indices de la tabla `inventarios_sucursales`
--
ALTER TABLE `inventarios_sucursales`
...
--
-- AUTO_INCREMENT de la tabla `inventarios_sucursales`
--
ALTER TABLE `inventarios_sucursales`
...
--
-- Filtros para la tabla `inventarios_sucursales`
--
ALTER TABLE `inventarios_sucursales`
  ADD CONSTRAINT `inventarios_sucursales_ibfk_1` FOREIGN KEY (`sucursal_id`) REFERENCES `sucursales` (`sucursal_id`),
  ADD CONSTRAINT `inventarios_sucursales_ibfk_2` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`producto_id`);
